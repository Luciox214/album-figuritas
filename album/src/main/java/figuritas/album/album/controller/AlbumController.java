...
public class AlbumController {
    ...
    public ResponseEntity<String> crearAlbum(@RequestBody Album album) {
        ...
        return ResponseEntity
                ...
                .body("Álbum creado con éxito: " + nuevo.getTitulo());
    }
    ...
    public ResponseEntity<String> cargarFiguritas(@PathVariable Long id, @RequestBody List<Sticker> stickers) {
        Album actualizado = albumService.cargarAlbum(id, stickers);
        return ResponseEntity.ok("Se cargaron " + stickers.size() + " figuritas al álbum " + actualizado.getTitulo());
    }
    ...
    public ResponseEntity<String> eliminarAlbum(@PathVariable Long id) {
        ...
        return ResponseEntity.ok("Álbum eliminado correctamente con ID: " + id);
    }
    ...
    public ResponseEntity<List<UserSticker>> obtenerFiguritasRepetidas(
            @RequestParam Long userId) {

        return ResponseEntity.ok(albumService.obtenerFiguritasRepetidas(userId));
    }
    ...
    public ResponseEntity<String> obtenerPorcentajeAlbumCompleto(
            @RequestParam Long userId,
